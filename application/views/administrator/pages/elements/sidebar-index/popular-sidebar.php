...
echo form_hidden('elements[]', 'popular-sidebar');
?>		
<div class="box-header with-border"> Berita Terpopuler </div>
<div class="box-body">
	<div class="form-group">
		<label for="popular-sidebar[name]" class="control-label col-md-3 col-xs-12">Nama Element : </label>
		<div class="col-md-8 bottom2x">
			<input type="text" name="popular-sidebar[name]" class="form-control" value="<?php echo $box->meta_name; ?>">
		</div>
	</div>
	<div class="form-group ">
		<label class="control-label col-md-3">Jumlah Berita : </label>
		<div class="col-md-3">
			<select name="popular-sidebar[json][limit]" id="input" class="form-control" required="required">
		...
		<div class="col-md-3 bottom2x">
			<select name="popular-sidebar[status]" id="input" class="form-control" required="required">
	...
	<div class="form-group">
		...
		<div class="col-md-3">
			<select name="popular-sidebar[json][sticky]" class="form-control" required="required">
