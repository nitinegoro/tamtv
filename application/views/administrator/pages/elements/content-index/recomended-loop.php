...
echo form_hidden('elements[]', 'recomended-loop');
?>		
<div class="box-header with-border"> Berita Pilihan</div>
<div class="box-body">
	<div class="form-group">
		<label for="recomended-loop[name]" class="control-label col-md-3 col-xs-12">Nama Element : </label>
		<div class="col-md-8 bottom2x">
			<input type="text" name="recomended-loop[name]" class="form-control" value="<?php echo $box->meta_name; ?>">
		</div>
	</div>
	<div class="form-group ">
		<label class="control-label col-md-3">Jumlah Berita : </label>
		<div class="col-md-3">
			<select name="recomended-loop[json][limit]" id="input" class="form-control" required="required">
			<?php 
			$number = 3;
			while( $number <=30  ) : ?>
		...
		<div class="col-md-3 bottom2x">
			<select name="recomended-loop[status]" id="input" class="form-control" required="required">
